...
(($, Drupal) => {
  ...
  Drupal.behaviors.entityContentDetailsSummaries = {
    attach(attachContext) {
      ...
      $attachContext.find('.entity-content-form-revision-information').drupalSetSummary((context) => {
      ...
      $attachContext.find('details.entity-translation-options').drupalSetSummary((context) => {
